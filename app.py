...
singleOrRound_label = Label(
    app, text='0 For Single/ 1 For Round: ', font=('bold', 14), pady=20, padx=25)
...
departingFrom_label = Label(
    app, text='Departing From: ', font=('bold', 14), pady=20, padx=25)
...
arrivingTo_label = Label(app, text='Arriving To: ',
                         font=('bold', 14), pady=20, padx=25)
...
# Departing Day
departingDay = StringVar(value=datetime.datetime.now().day)
departingDay_label = Label(
    app, text='Departing Day(DD): ', font=('bold', 14), pady=20, padx=25)
...
# Departing Month
departingMonth = StringVar(value=datetime.datetime.now().month)
departingMonth_label = Label(
    app, text='Departing Month(MM): ', font=('bold', 14), pady=20, padx=25)
...
# Departing Year
departingYear = StringVar(value=datetime.datetime.now().year)
departingYear_label = Label(
    app, text='Departing Year(YYYY): ', font=('bold', 14), pady=20, padx=25)
...
# Arriving Day
arrivingDay = StringVar(value=datetime.datetime.now().day)
arrivingDay_label = Label(app, text='Arriving Day(DD): ',
                          font=('bold', 14), pady=20, padx=25)
...
# Arriving Month
arrivingMonth = StringVar(value=datetime.datetime.now().month)
arrivingMonth_label = Label(
    app, text='Arriving Month(MM): ', font=('bold', 14), pady=20, padx=25)
...
# Arriving Year
arrivingYear = StringVar(value=datetime.datetime.now().year)
arrivingYear_label = Label(
    app, text='Arriving Year(YYYY): ', font=('bold', 14), pady=20, padx=25)
...
connections_label = Label(app, text='Connections: ',
                          font=('bold', 14), padx=25, pady=20)
...
is_travelbrands_checked = IntVar()
is_royalscenic_checked =IntVar() 
is_airnets_checked =IntVar() 
is_googleflights_checked = IntVar()

travelbrands_box = Checkbutton(
    app, text="Travelbrands", variable=is_travelbrands_checked)
royalscenice_box = Checkbutton(
    app, text="Royal Scenic", variable=is_royalscenic_checked)
airnets_box = Checkbutton(app, text="Airnets", variable=is_airnets_checked)
googleflights_box = Checkbutton(
    app, text="Google", variable=is_googleflights_checked)

travelbrands_box.grid(row=5, column=2)
royalscenice_box.grid(row=5, column=3)
airnets_box.grid(row=5, column=4)
googleflights_box.grid(row=5, column=5)
...
def search(threeDays=False):
    ...
    if(is_googleflights_checked.get() == 1):
        googleFlights.start()
    ...
    if(is_travelbrands_checked.get() == 1):
        travelBrands.start()
    ...
    if(is_royalscenic_checked.get() == 1):
        royalScenic.start()
...
search_button_3 = Button(app, text="Search +-3",
                         height=3, width=15, command=search3Days)
